...
public class GeigerCounter extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(new TranslatableText("item.libradioactive.geiger_counter.explication"));
        tooltip.add(new TranslatableText("item.libradioactive.geiger_counter.explication.player"));
        tooltip.add(new TranslatableText("item.libradioactive.geiger_counter.explication.entity"));
        tooltip.add(new TranslatableText("item.libradioactive.geiger_counter.explication.chunk"));
        tooltip.add(new TranslatableText("item.libradioactive.geiger_counter.explication.block"));
